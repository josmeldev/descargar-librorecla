...
class HomeController extends Controller
{
    ...
    public function consultarDatosClientesA(){
        ...
        return view('administration.clientes.clientes-atendidos', compact('datosClientesA'));
    ...
    public function ConsultaReclamosEnAtencionPN(){
        ...
        return view('administration.reclamos.en_atencion', compact('reclamosEnAtencionPN'));
    }
